...
data/          de-identified study inputs; TCGA files fetched separately (see data/README.md)
...
ROI-level data needed to reproduce the figures are included in `data/` and in
the Code Ocean capsule; see `data/README.md`. Slides and ROIs carry neutral
codes, and no raw sequencing data or patient identifiers are stored in this
repository.
